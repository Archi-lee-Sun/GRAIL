...
function GobletIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 32 32" aria-hidden="true">
      <defs>
        <linearGradient id="registerGobletGold" x1="0" x2="1" y1="0" y2="1">
          <stop offset="0" stopColor="#FFE08A" />
          <stop offset="0.55" stopColor="#F59E0B" />
          <stop offset="1" stopColor="#A16207" />
        </linearGradient>
      </defs>
      <path d="M9 4h14v5c0 5.1-2.5 8.5-6.1 9.1V23h4.3v3H10.8v-3h4.3v-4.9C11.5 17.5 9 14.1 9 9V4Z" fill="url(#registerGobletGold)" />
